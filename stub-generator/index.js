...
async function extensionSelector(title, additionalLines, core){
    let coreDefaultExtensions = {
        ...
        arduboy: "hex arduboy",
        bk: "bin img dsk bkd",
        c64: "d64 d6z d71 d7z d80 d81 d82 d8z g64 g6z g41 g4z x64 x6z nib nbz d2m d4m t64 tap tcrt prg p00 crt bin cmd m3u vfl vsf zip 7z gz 20 40 60 a0 b0 rom",
        c64f: "d64 d6z d71 d7z d80 d81 d82 d8z g64 g6z g41 g4z x64 x6z nib nbz d2m d4m t64 tap tcrt prg p00 crt bin cmd m3u vfl vsf zip 7z gz 20 40 60 a0 b0 rom",
        c64fc: "d64 d6z d71 d7z d80 d81 d82 d8z g64 g6z g41 g4z x64 x6z nib nbz d2m d4m t64 tap tcrt prg p00 crt bin cmd m3u vfl vsf zip 7z gz 20 40 60 a0 b0 rom",
        c64sc: "d64 d6z d71 d7z d80 d81 d82 d8z g64 g6z g41 g4z x64 x6z nib nbz d2m d4m t64 tap tcrt prg p00 crt bin cmd m3u vfl vsf zip 7z gz 20 40 60 a0 b0 rom",
        cavestory: "exe",
        cdg: "cdg",
        chip8: "ch8 sc8 xo8 hc8",
        col: "col cv bin rom",
        dblcherrygb: "gb gbc sgb",
        fake08: "p8 png",
        fcf: "bin rom chf",
        ...
        gong: "game",
        gpgx: "m3u mdx md smd gen bin cue iso chd bms sms gg sg 68k sgd",
        gw: "mgw",
        int: "int rom bin",
        jnb: "dat",
        lnx: "lnx o",
        ...
        nesq: "nes",
        nest: "nes fds unf unif",
        ngpc: "ngp ngc ngpc npc",
        outrun: "game 88",
        pc8800: "d88 u88 m3u",
        pce: "pce cue ccd chd toc m3u",
        pcesgx: "pce sgx cue ccd chd",
        pcfx: "cue ccd toc chd",
        pokem: "min",
        ...
        vb: "vb vboy bin",
        vec: "bin vec",
        vic20: "d64 d6z d71 d7z d80 d81 d82 d8z g64 g6z g41 g4z x64 x6z nib nbz d2m d4m t64 tap tcrt prg p00 crt bin cmd m3u vfl vsf zip 7z gz 20 40 60 a0 b0 rom",
        wolf3d: "wl6 n3d sod sdm wl1 pk3 exe",
        xmil: "dx1 zip 2d 2hd tfd d88 88d hdm xdf dup cmd",
        wsv: "bin sv",
        wswan: "ws wsc pc2",
        xrick: "zip",
        zx81: "p tzx t81"
